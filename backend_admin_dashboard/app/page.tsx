...
export default function Home() {
  ...
  const monthlyData = blogsData
    ...
    .reduce((acc: { [key: number]: number[] }, blog) => {
  ...
  const datasets = years.map((year) => ({
    label: `${year}`,
    data: monthlyData[parseInt(year)] || Array(12).fill(0),
        ...
        <div className="dashboard">
          ...
          <div className="topfourcards flex flex-sb">
            ...
            <div className="four_card" data-aos="fade-left">
              <h2>Draft Blogs</h2>
              <span>
                {blogsData.filter((dat) => dat.status === "draft").length}
              </span>
            </div>
          </div>
          {/* year overview */}
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        {
                          blogsData.filter(
                            (dat) => dat.blogcategory[0] === "htmlcssjs"
                          ).length
                        }
                      </td>
                    </tr>
